...
Instancias de comportamiento abusivo, acosador o inaceptable de otro modo podrán ser reportadas a los administradores de la comunidad responsables del cumplimiento a través de [it@democraciaenred.org](mailto:it@democraciaenred.org). Todas las quejas serán evaluadas e investigadas de una manera puntual y justa.
